define(['jquery', 'bootstrap', 'backend', 'form', 'table'], function ($, undefined, Backend, Form, Table) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'report/attachment/index?ids='+report_id,
                    add_url: 'report/attachment/add?ids='+report_id,
                    edit_url: 'report/attachment/edit?ids='+report_id,
                    del_url: 'report/attachment/del?ids='+report_id,
                    multi_url: 'report/attachment/multi?ids='+report_id,
                    table: 'attachment'
                }
            });
        ...
        select: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'report/attachment/select',
                }
            });
            var urlArr = [];
